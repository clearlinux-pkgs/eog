...
%prep
%setup -q -n eog-42.2
cd %{_builddir}/eog-42.2
pushd ..
cp -a eog-42.2 buildavx2
popd
...
cp %{_builddir}/eog-42.2/COPYING %{buildroot}/usr/share/package-licenses/eog/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/eog-42.2/help/C/license.page %{buildroot}/usr/share/package-licenses/eog/99449fd3e6417f1f32dbe2a5b252880badb25704
