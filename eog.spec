...
Version  : 42.1
Release  : 56
URL      : https://download.gnome.org/sources/eog/42/eog-42.1.tar.xz
Source0  : https://download.gnome.org/sources/eog/42/eog-42.1.tar.xz
...
%prep
%setup -q -n eog-42.1
cd %{_builddir}/eog-42.1
pushd ..
cp -a eog-42.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650846121
...
cp %{_builddir}/eog-42.1/COPYING %{buildroot}/usr/share/package-licenses/eog/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/eog-42.1/help/C/license.page %{buildroot}/usr/share/package-licenses/eog/99449fd3e6417f1f32dbe2a5b252880badb25704
