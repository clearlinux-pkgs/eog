...
Source0  : https://download.gnome.org/sources/eog/3.38/eog-3.38.2.tar.xz
...
%prep
%setup -q -n eog-3.38.2
cd %{_builddir}/eog-3.38.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613499725
...
cp %{_builddir}/eog-3.38.2/COPYING %{buildroot}/usr/share/package-licenses/eog/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/eog-3.38.2/help/C/license.page %{buildroot}/usr/share/package-licenses/eog/99449fd3e6417f1f32dbe2a5b252880badb25704
